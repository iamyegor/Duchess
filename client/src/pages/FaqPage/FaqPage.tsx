            ...
            <div className="my-6 container">
                ...
                <div>
                    <AccordionItem question="Как оформить абонемент?">
                        <div className="space-y-7">
                            ...
                            <ol className="list-decimal list-inside space-y-2">
                                <li>
                                    Заполните номер телефон, выберите клуб для тренировок, дату
                                    начала тренировок.
                                </li>
                                <li>Заполните все необходимые персональные данные.</li>
                                <li>
                                    Оплатите абонемент банковской картой: первая оплата состоит из
                                    вступительного платежа и стоимости ежемесячного абонемента. Со
                                    2-го месяца вы оплачиваете только стоимость абонемента.
                                </li>
                                <li>
                                    Приходите в клуб и забирайте ваш личный браслет на ресепшене.
                                </li>
                            </ol>
                            <p>
                    ...
                    <AccordionItem question="Что входит в ежемесячный абонемент?">
                        <div className="space-y-7">
                            ...
                            <ul className="list-disc list-inside space-y-2">
                                ...
                                <li>
                                    DUCHESS INTRO - программа адаптации и знакомства с оборудованием
                                    в мини-группах в тренажерном зале;
                                </li>
                    ...
                    <AccordionItem question="Зачем платить вступительный взнос?">
                        <div className="space-y-7">
                            <p>
                                Вступительный взнос является обязательным и оплачивается один раз,
                                если членство не прерывается.
                            </p>
                            <p>В него входит:</p>
                            <ul className="list-disc list-inside space-y-2">
                                <li>
                                ...
                                <li>
                                    Неограниченное проведение анализа состава тела на аппарате
                                    InBody;
                                </li>
                                <li>
